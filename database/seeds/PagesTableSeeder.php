...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $carditem->image = "images/project1.png";
        $carditem->technologies = json_encode(['Laravel','SASS','Bootstrap','JavaScript']);
        $carditem->save();
        $carditem = new \App\CardItem();
        $carditem->card_list_id = $cardlist->id;
        $carditem->title = "Project 2";
        $carditem->description = "Some quick example text to build on the card title and make up the bulk of the card's content.";
        $carditem->image = "https://via.placeholder.com/1920x1080";
        $carditem->save();
        $carditem = new \App\CardItem();
        $carditem->card_list_id = $cardlist->id;
        $carditem->title = "Project 2";
